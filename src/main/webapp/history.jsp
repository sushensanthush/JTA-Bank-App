...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        h1 { color: var(--primary); font-size: 1.6rem; margin-bottom: 1.5rem; }
        ...
        th { background-color: #f1f5f9; color: #475569; padding: 1rem 1.25rem; font-size: 0.85rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; border-bottom: 1px solid var(--border); }
...
<div class="container">
    <h1>Transaction History for ${requestScope.accountNo}</h1>
